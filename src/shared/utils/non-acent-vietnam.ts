class VietnameseAccentConverter {
	// This method converts the string to lowercase, then perform the conversion
	...
	// This method keeps the casing unchanged for str, then perform the conversion
	public static toNonAccentVietnamese(str: string): string {
